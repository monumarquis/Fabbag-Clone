        ...
        <Container as={Stack} maxW={'6xl'} mb='20'>
          <SimpleGrid
            ...
            <Stack align={'flex-start'} spacing="5">
              ...
              <Link color="gray"  _hover={{textdeoration:"none" , color:"#ECC94B"}} href={'#'}>About us</Link>
              <Link  color="gray" _hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>Associative Brands</Link>
              <Link  color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>FAQ</Link>
              <Link color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>Collaborate with Fab Bag</Link>
              <Link color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>Contact us</Link>
              <Link color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>Returns & Refunds</Link>
              <Link color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>Terms & Conditions</Link>
            </Stack>
            <Stack align={'flex-start'} spacing="5">
              <ListHeader>CUSTOMER CARE</ListHeader>
              <VStack spacing="-1"><Box color="gray" ml="-20">Call : <Link color="black"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>022-6805-6010</Link></Box><Box color="gray">(Monday to Friday : 9 AM - 7 PM)</Box></VStack>
              <Box color="gray">Mail :<Link color="gray"_hover={{textdeoration:"none" , color:"#ECC94B"}}href={'#'}>crew@fabag.com</Link></Box>
